            ...
            while loop:
                try:
                    ...
                    if validate(date_format) == True:
                        ...
                        try:
                            self.date = datetime.date(int(in_date[0]), int(in_date[1]), int(in_date[2]))
        ...
        def delete_now(self):
            ...
            while loop == True:
                try:
                    if self.choice == '1':
                        loop = False
                        typeframe = pd.read_sql_query('SELECT * FROM plan where status = 2', conn)
                                ...
                                if self.type in typeframe.type.values:
                                    ...
                                    while loop2 == True:
                                        try:
                                            ...
                                            camp = row[5]
                                            status = row[6]
                                            self.close = datetime.date(int(in_date[0]), int(in_date[1]), int(in_date[2]))
